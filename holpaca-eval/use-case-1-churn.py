...
#         'operationcount.0': 21259992,
#         'operationcount.1': 19073868,
#         'operationcount.2': 1939643,
#         'operationcount.3': 533385,
#     }),
      Setup('holpaca', ycsb_executable, {
          **ycsb_config,
          'cachelib.poolresizer': 'on',
          #'cachelib.poolrebalancer': 'on',
          'cachelib.pool.noinitialsize': 'on', # needed since pools can have all the size of the cache mid run
          # based on baseline results
          'maxexecutiontime': 3600,
          'operationcount.0': 21259992,
          'operationcount.1': 19073868,
