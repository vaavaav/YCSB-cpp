...
#        'name': 'CacheLib-Holpaca (T=10s)',
#        'controllerArgs': '10000 hit_ratio_maximization_with_qos 0.05 1 0.5',
...
#        'name': 'CacheLib-Holpaca (T=100ms)',
#        'controllerArgs': '100 hit_ratio_maximization_with_qos 0.05 1 0.5',
...
#        'name': 'CacheLib-Holpaca (T=10ms)',
#        'controllerArgs': '10 hit_ratio_maximization_with_qos 0.05 1 0.5',
...
#        }
#    },
    'CacheLib-Holpaca (delta=0.01)' : {
        'name': 'δ: 0.01',
        'controllerArgs': '1000 hit_ratio_maximization 0.01',
        'resultsDir': f'cachelib_holpaca_1',
        'overrideConfigs' : {
            'cachelib.holpaca': 'on',
        }
    },
    'CacheLib-Holpaca (delta=0.05)' : {
        'name': 'δ: 0.05',
        'controllerArgs': '1000 hit_ratio_maximization 0.05',
        'resultsDir': f'cachelib_holpaca_5',
        'overrideConfigs' : {
            'cachelib.holpaca': 'on',
        }
    },
    'CacheLib-Holpaca (delta=0.1)' : {
        'name': 'δ: 0.1',
        'controllerArgs': '1000 hit_ratio_maximization 0.1',
        'resultsDir': f'cachelib_holpaca_10',
        'overrideConfigs' : {
            'cachelib.holpaca': 'on',
        }
    },
    'CacheLib-Holpaca (delta=0.25)' : {
        'name': 'δ: 0.25',
        'controllerArgs': '1000 hit_ratio_maximization 0.25',
        'resultsDir': f'cachelib_holpaca_25',
        'overrideConfigs' : {
            'cachelib.holpaca': 'on',
        }
    },
    'CacheLib-Holpaca (delta=0.5)' : {
        'name': 'δ: 0.5',
        'controllerArgs': '1000 hit_ratio_maximization 0.5',
        'resultsDir': f'cachelib_holpaca_50',
        'overrideConfigs' : {
            'cachelib.holpaca': 'on',
        }
    },
    'CacheLib-Holpaca (delta=1)' : {
        'name': 'δ: 1',
        'controllerArgs': '1000 hit_ratio_maximization 1',
        'resultsDir': f'cachelib_holpaca_100',
        'overrideConfigs' : {
            'cachelib.holpaca': 'on',
        }
