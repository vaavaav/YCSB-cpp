...
class CacheLibLRU2Q : public DB {

public:
  using CacheAllocator = facebook::cachelib::Lru2QAllocator;
...
public:
  explicit CacheLibLRU2Q(int threadId) : threadId_(threadId) {}
...
DB *NewCacheLibLRU2Q(int threadId);
